      ...
      {category && (
        <div className="mb-10">
          <div className="flex items-center mb-2">
            <Link href="/" className="text-gray-500 hover:text-[#1F6F78]">
              Home
            </Link>
            <span className="mx-2">/</span>
            <Link href="/products" className="text-gray-500 hover:text-[#1F6F78]">
              Products
            </Link>
            <span className="mx-2">/</span>
            <span className="text-[#1F6F78]">{category.name}</span>
          </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        ...
        <div className="flex items-center mt-4 sm:mt-0">
          ...
          <select
            id="sort"
            name="sort"
            className="rounded-md border-gray-300 shadow-sm focus:border-[#1F6F78] focus:ring-[#1F6F78]"

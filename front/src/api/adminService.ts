...
export const products = {
  ...
  reorderProductImages: (
    ...
    return api.patch(`/api/admin/products/${productId}/images/reorder`, {
      imageOrders,
    });
  },
  // Product Variants
...
export const shoppableCarousel = {
  getCarousel: () => api.get("/api/admin/shoppable-carousel"),
  updateCarousel: (data: { autoScroll?: boolean; isActive?: boolean }) =>
    api.patch("/api/admin/shoppable-carousel", data),
  createItem: (formData: FormData) =>
    api.post("/api/admin/shoppable-carousel/items", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  updateItem: (itemId: string, formData: FormData) =>
    api.put(`/api/admin/shoppable-carousel/items/${itemId}`, formData, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  reorderItems: (itemIds: string[]) =>
    api.patch("/api/admin/shoppable-carousel/items/reorder", { itemIds }),
  deleteItem: (itemId: string) =>
    api.delete(`/api/admin/shoppable-carousel/items/${itemId}`),
};

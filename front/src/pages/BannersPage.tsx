              ...
              {desktopPreview ? (
                <div className="space-y-4">
                  <img
                    ...
                    className="w-full aspect-[1900/400] object-cover mx-auto rounded-lg border border-[var(--border-color)] shadow-sm"
                  />
              ...
              {mobilePreview ? (
                <div className="space-y-4">
                  <img
                    ...
                    className="w-full max-w-[400px] aspect-[1000/450] object-cover mx-auto rounded-lg border border-[var(--border-color)] shadow-sm"
                  />
                  <p className="text-sm text-[var(--text-secondary)]">
                  ...
                  <div className="flex gap-3 flex-shrink-0">
                    <div className="relative group">
                      ...
                      <img
                        ...
                        className="w-48 aspect-[1900/400] object-cover rounded-lg border border-[var(--border-color)] shadow-sm"
                      />
                    </div>
                    <div className="relative group">
                      <div className="absolute -top-2 -left-2 bg-primary text-primary-foreground text-xs px-2 py-0.5 rounded-full">
                      ...
                      <img
                        ...
                        className="w-24 aspect-[1000/450] object-cover rounded-lg border border-[var(--border-color)] shadow-sm"
                      />
                    </div>
                  </div>

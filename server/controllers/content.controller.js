  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | nutrybites",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/nutrybites",
          instagram: "https://instagram.com/nutrybites",
          twitter: "https://twitter.com/nutrybites",
        },
      };
    ...
    const contactInfo = {
      ...
      phone: "+91 8053210008",
      email: "connect.nutrybites@gmail.com",
      ...
      metaTitle: "Contact Us | nutrybites",
      metaDescription:

...
<head>
    ...
    <style>
        ...
        .header {
            background: linear-gradient(135deg, #1F6F78, #144D53);
            color: #ffffff;
            text-align: center;
            padding: 40px;
        }
...
<body>
    ...
    store.storeDescription
            ...
            <div class="features">
                ...
                <div class="feature-item">Shop for crispy, healthy makhana snacks</div>
...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #1F6F78, #144D53); color: #fff; text-align: center; padding: 32px; }
        .content { padding: 32px; }
        h1 { margin: 0; font-size: 24px; font-weight: 700; }
        p { margin: 0 0 16px; font-size: 16px; color: #333; }
        .otp { font-size: 32px; letter-spacing: 8px; font-weight: 700; color: #144D53; background: #f0f9f8; padding: 12px 16px; border-radius: 8px; text-align:center; display:inline-block; }
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Account Deletion Request - Nutry Bites</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
        ...
        .header {
            background: linear-gradient(135deg, #E6A15A, #d68e4a);
            color: #ffffff;
            text-align: center;
            padding: 40px;
        }
...
<body>
    <div class="container">
        <div class="header">
            <h1>Healthy Snacks Anytime</h1>
        </div>
        <div class="content">
            <h2>Account Deletion Request</h2>
            <p>Dear Valued Student,</p>
            <p>We've received a request to delete your Nutry Bites account. Before proceeding, we want to ensure this is your intended action, as it will affect your access to classes, learning materials, and progress records.</p>
...
<head>
    ...
    <style>
        ...
        .container { max-width: 600px; margin: 20px auto; background: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 0 20px rgba(0,0,0,0.1); }
        .header { background: linear-gradient(135deg, #1e3a5f, #0f172a); color: #fff; text-align: center; padding: 40px; }
        .content { padding: 40px; }
        h1 { margin: 0; font-size: 28px; }
        h2 { color: #1a1a1a; font-size: 20px; margin-top: 0; }
        p { margin-bottom: 20px; font-size: 16px; }
        .button { display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #1e3a5f, #0f172a); color: #fff; text-decoration: none; border-radius: 8px; font-weight: bold; }
        .footer { text-align: center; padding: 20px; font-size: 12px; color: #666; background: #f8f8f8; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="margin-top:24px; font-size:14px; color:#666;">This link expires in 1 hour. If you didn't request this, secure your account and contact support.</p>
        </div>
        <div class="footer">© ${new Date().getFullYear()} ${store.storeName} | Admin Dashboard</div>
    </div>
</body>
</html>
`;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Fee Payment Receipt - Nutry Bites</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for your payment. Your transaction for healthy snacks was successful.</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>New Fee Assignment - Nutry Bites</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Payment Successful - Nutry Bites</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear ${data.userName},</p>
            <p>Your payment for healthy snacks has been successfully processed. Here are your transaction details:</p>
            ...
            <p>Thank you for your prompt payment! We look forward to your healthy snacking journey with Nutry Bites.</p>
        </div>
        <div class="footer">
            <p>© ${new Date().getFullYear()} Nutry Bites | Healthy Snacks Anytime</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Payment Failed - Nutry Bites</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear ${data.userName},</p>
            <p>We're sorry, but your recent payment attempt for healthy snacks was unsuccessful.</p>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear ${name},</p>
            <p>This is to inform you that there has been an update regarding your order: <strong>${feeTitle}</strong></p>
        ...
        <div class="footer">
            <p>Nutry Bites | Healthy Snacks Anytime</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Certificate Generated - Nutry Bites</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>New Contact Form Submission - Nutry Bites</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>${data.subject || "Inquiry About Our Snacks"}</h2>
            ...
            <p>Please respond to this inquiry about our healthy makhana snacks at your earliest convenience.</p>
        </div>
        <div class="footer">
            © ${new Date().getFullYear()} Nutry Bites | Healthy Snacks Anytime<br>
